...
class CurrencyField extends BaseField {
    ...
    render() {
        ...
        return (
            ...
            ?
            <input className={'fstextinput'} type='number' data-field={this.props.field} data-type='currency' min="1" step="any" value={this.state.value} onChange={this.handleChange} disabled={disabled} required={required} maxLength={this.state.fieldinfo.MaxLength} />
            :
