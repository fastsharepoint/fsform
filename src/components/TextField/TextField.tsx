...
class TextField extends BaseField {
    ...
    render() {
        ...
        return (
            ...
            ?
            <input className={'fstextinput'} type='text' data-field={this.props.field} data-type='text' value={this.state.value} onChange={this.handleChange} disabled={disabled} required={required} maxLength={this.state.fieldinfo.MaxLength} />
            :
